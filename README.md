...
for further details on the library in the Mathematica file `Dislocations.nb`. It outlines all the user-intended functions, covers important implementation details and conversions from math to code, and gives a few examples.
