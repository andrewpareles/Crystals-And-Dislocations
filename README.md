...
This library lets you generate an arbitrary crystal structure of choice (represented by a Hamiltonian matrix). You can add dislocations to the crystal (modifying the Hamiltonian), and you can numerically solve Schrodinger's equation and visualize the result.
